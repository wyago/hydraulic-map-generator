    ...
    return {
        inform(tiles: TileSet, i: number) {
            ...
            info = h("details.modal", { key: "info" }, [
                ...
                h("p", ["Snow: " + tiles.snow[i].toFixed(2)]),
                h("details", [
                    h("summary", ["Ground: " + tiles.rockElevation(i).toFixed(2)]),
                    h("p", ["Rock: " + tiles.hard[i].toFixed(2)]),
                    h("p", ["Soft rock: " + tiles.soft[i].toFixed(2)]),
                    h("p", ["Silt: " + tiles.silt[i].toFixed(2)]),
                ]),
                h("details", [
                    h("summary", ["Surface water: " + tiles.surfaceWater(i).toFixed(4)]),
